...
*To produce the html, render Final Report.qmd*
...
the quarto html. The help from AI allowed me to realize that I could only reference a table
after rendering it in my quarto document. The transcript is located in the "AI Help" quarto document. 
